...
##  Данные
данные представлены в 2х датасетах  `ab_test_participants` , который с информацией об участниках тестов, также   `ab_test_events` с данными о зарегистрированных событиях.
